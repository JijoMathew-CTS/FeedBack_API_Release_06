...
public class EventSummaryService {
	...
	public List<IEventReport> getEventDetails(String role,String id) {
		List<EventDetails> eventsData=new ArrayList<>();
		if(role !=null && role.trim().equalsIgnoreCase("ROLE_POC")) {
		...
		List<IEventReport> eventResponse=new ArrayList<>();
